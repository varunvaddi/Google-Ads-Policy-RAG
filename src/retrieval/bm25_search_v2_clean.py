...
class BM25SearchV2Clean:
    ...
    def __init__(self):
        ...
        # Load clean chunks
        with open('data/processed_v2/chunks_clean.json', 'r', encoding='utf-8') as f:
            self.chunks = json.load(f)
        
        # Load clean BM25 index
        with open('data/embeddings_v2/bm25_clean.pkl', 'rb') as f:
