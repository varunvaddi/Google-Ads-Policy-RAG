...
class GoogleAdsPolicyScraperComplete:
    """
    Complete scraper that gets all 25 policy pages with full section content
    """
    
    def __init__(self, output_dir: str = "data/raw_final"):
    ...
    def get_all_policy_urls(self) -> Dict[str, List[Dict]]:
        ...
        return {
            "prohibited_content": [
                ...
                {"title": "Malicious or unwanted software", "url": "https://support.google.com/adspolicy/answer/1316548"},
                {"title": "Misrepresentation", "url": "https://support.google.com/adspolicy/answer/6020955"},
                {"title": "Endangered species", "url": "https://support.google.com/adspolicy/answer/12266551"},
            ],
            ...
            "restricted_content": [
                {"title": "Adult content", "url": "https://support.google.com/adspolicy/answer/6023699"},
...
def main():
    ...
    scraper = GoogleAdsPolicyScraperComplete()
